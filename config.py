...
data_dir = "s3://sagemaker-jhgan-workspace/" # /opt/ml/input/data
result_dir = "/opt/ml/" #os.environ["SM_OUTPUT_DIR"]
#----------------------------------------------------------------------------
# TensorFlow options.
...
#     resume_run_id="/opt/ml/input/data/snapshot/network-snapshot-007405.pkl",
#     resume_kimg=7405
...
# Dataset (choose one).
desc += '-LiTS';            dataset = EasyDict(tfrecord_dir='LiTS-window-liver-08/output/output-1/'); train.mirror_augment = True
...
desc += '-preset-v2-8gpus'; num_gpus = 8; sched.minibatch_base = 128; sched.minibatch_dict = {4: 2048, 8: 1024, 16: 512, 32: 256, 64: 128}; sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
